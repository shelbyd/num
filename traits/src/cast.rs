...
pub trait ToPrimitive {
    ...
    fn to_isize(&self) -> Option<isize> {
        self.to_i128().and_then(|x| x.to_isize())
    }

    /// Converts the value of `self` to an `i8`.
    #[inline]
    fn to_i8(&self) -> Option<i8> {
        self.to_i128().and_then(|x| x.to_i8())
    }

    /// Converts the value of `self` to an `i16`.
    #[inline]
    fn to_i16(&self) -> Option<i16> {
        self.to_i128().and_then(|x| x.to_i16())
    }

    /// Converts the value of `self` to an `i32`.
    #[inline]
    fn to_i32(&self) -> Option<i32> {
        self.to_i128().and_then(|x| x.to_i32())
    }

    /// Converts the value of `self` to an `i64`.
    #[inline]
    fn to_i64(&self) -> Option<i64> {
        self.to_i128().and_then(|x| x.to_i64())
    }
    ...
    fn to_usize(&self) -> Option<usize> {
        self.to_u128().and_then(|x| x.to_usize())
    }

    /// Converts the value of `self` to an `u8`.
    #[inline]
    fn to_u8(&self) -> Option<u8> {
        self.to_u128().and_then(|x| x.to_u8())
    }

    /// Converts the value of `self` to an `u16`.
    #[inline]
    fn to_u16(&self) -> Option<u16> {
        self.to_u128().and_then(|x| x.to_u16())
    }

    /// Converts the value of `self` to an `u32`.
    #[inline]
    fn to_u32(&self) -> Option<u32> {
        self.to_u128().and_then(|x| x.to_u32())
    }

    /// Converts the value of `self` to an `u32`.
    #[inline]
    fn to_u64(&self) -> Option<u64> {
        self.to_u128().and_then(|x| x.to_u64())
    }
    ...
    ($SrcT:ty, $DstT:ty, $slf:expr) => (
        {
            if size_of::<$SrcT>() <= size_of::<$DstT>() {
                ...
                if min_value as i128 <= n && n <= max_value as i128 {
                    Some($slf as $DstT)
                } else {
                    None
                }
    ...
    ($SrcT:ty, $DstT:ty, $slf:expr) => (
        {
            ...
            let max_value: $DstT = Bounded::max_value();
            if zero <= $slf && $slf as u128 <= max_value as u128 {
                Some($slf as $DstT)
            } else {
                None
            }
...
macro_rules! impl_to_primitive_int {
    ($T:ty) => (
        impl ToPrimitive for $T {
            ...
            #[inline]
            fn to_i128(&self) -> Option<i128> { impl_to_primitive_int_to_int!($T, i128, *self) }
            ...
            #[inline]
            fn to_u128(&self) -> Option<u128> { impl_to_primitive_int_to_uint!($T, u128, *self) }
...
macro_rules! impl_to_primitive_uint_to_int {
    ($DstT:ty, $slf:expr) => (
        {
            let max_value: $DstT = Bounded::max_value();
            if $slf as u128 <= max_value as u128 {
                Some($slf as $DstT)
            } else {
                None
            }
...
macro_rules! impl_to_primitive_uint {
    ($T:ty) => (
        impl ToPrimitive for $T {
            ...
            #[inline]
            fn to_i128(&self) -> Option<i128> { impl_to_primitive_uint_to_int!(i128, *self) }
            ...
            #[inline]
            fn to_u128(&self) -> Option<u128> { impl_to_primitive_uint_to_uint!($T, u128, *self) }
...
pub trait FromPrimitive: Sized {
    ...
    fn from_isize(n: isize) -> Option<Self> {
        FromPrimitive::from_i128(n as i128)
    }
...
fn wrapping_to_primitive() {
    test_wrapping_to_primitive!(usize u8 u16 u32 u64 u128 isize i8 i16 i32 i64 i128);
}
